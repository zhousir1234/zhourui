...
def get_info(all_move):
    f = open("D:\PYTHON\PY\可视化\\douban.csv", "a")
...
if __name__ == "__main__":
    if os.path.exists("D:\PYTHON\PY\可视化") == False:  # 两个if来判断是否文件路径存在 新建文件夹 删除文件
        os.mkdir("D:\PYTHON\PY\可视化")
    if os.path.exists("D:\PYTHON\PY\可视化\\douban.csv") == True:
        os.remove("D:\PYTHON\PY\可视化1\\douban.csv")
